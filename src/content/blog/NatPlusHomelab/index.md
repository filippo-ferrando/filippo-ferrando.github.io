...
Though a collegue a discovered Tailscale, and i was amazed by it's simplicity and feature-set, so i decided to give it a try.
...
I also installed Tailscale on a raspberry pi zero w (DietPI) to have a "deployable" node to use when i'm out, this way i can expose the lan were the pi is attached to my tailnet.
